    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = 1/2 * g * n * ( (ell)**(-1) * ( ( -1 + ( m )**( 2 ) ) )**( -1 ) * ( ( a )**( 3 ) * ( -1 + ( m )**( 2 ) ) + ( 5 * ( a )**( 2 ) * b * m * ( -1 + ( m )**( 2 ) ) + ( ( b )**( 3 ) * m * ( -13 + 15 * ( m )**( 2 ) ) + a * ( b )**( 2 ) * ( -3 + ( 31 * ( m )**( 2 ) + -30 * ( m )**( 4 ) ) ) ) ) ) + -3 * ( b )**( 2 ) * ( -1 + 5 * ( m )**( 2 ) ) * numpy.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = g * n * ( (ell)**(-1) * ( ( -1 + ( m )**( 2 ) ) )**( -1 ) * ( a * b * m * ( 5 + -6 * ( m )**( 2 ) ) + ( ( a )**( 2 ) * ( -1 + ( m )**( 2 ) ) + ( b )**( 2 ) * ( -2 + 3 * ( m )**( 2 ) ) ) ) + -3 * b * m * numpy.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                kernel = n * ( 1/4 * ( ( a + -1 * b ) )**( -4 ) * b * ( 2 * ( a )**( 2 ) * b \
                    * ( 11 + -54 * ( g )**( 2 ) ) + ( ( b )**( 3 ) * ( 6 + -25 * ( g )**( \
                    2 ) ) + ( 8 * ( a )**( 3 ) * ( -1 + 6 * ( g )**( 2 ) ) + 4 * a * ( b \
                    )**( 2 ) * ( -5 + 22 * ( g )**( 2 ) ) ) ) ) + ( 1 + -3 * ( g )**( 2 ) \
                    ) * np.log( ( a + -1 * b ) ) )
            elif np.abs(m + 1) < 1e-15:
