...
def cal_Vy_kernel(r_cal, phi_cal, lambda_cal, \
    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                kernel = h * n * ( -1/2 * a * ( ( a + -1 * b ) )**( -2 ) * ( ( a )**( 3 ) + ( \
                    4 * ( a )**( 2 ) * b + ( -18 * a * ( b )**( 2 ) + 12 * ( b )**( 3 ) ) \
                    ) ) + -6 * ( b )**( 2 ) * np.log( ( -1 * a + b ) ) )
            elif np.abs(m + 1) < 1e-15:
                kernel = h * n * ( 1/2 * a * ( ( a + b ) )**( -2 ) * ( ( a )**( 3 ) + ( -4 * \
                    ( a )**( 2 ) * b + ( -18 * a * ( b )**( 2 ) + -12 * ( b )**( 3 ) ) ) \
                    ) + 6 * ( b )**( 2 ) * np.log( ( a + b ) ) )
            else:
                kernel = 1/2 * h * n * ( ell * ( ( -1 + ( m )**( 2 ) ) )**( -1 ) * ( ( a )**( 3 ) * \
                    ( -1 + ( m )**( 2 ) ) + ( 5 * ( a )**( 2 ) * b * m * ( -1 + ( m )**( \
                    2 ) ) + ( ( b )**( 3 ) * m * ( -13 + 15 * ( m )**( 2 ) ) + a * ( b \
                    )**( 2 ) * ( -3 + ( 31 * ( m )**( 2 ) + -30 * ( m )**( 4 ) ) ) ) ) ) \
                    + -3 * ( b )**( 2 ) * ( -1 + 5 * ( m )**( 2 ) ) * np.log( ( -1 * a \
            ...
            kernel = ( a )**( 4 ) * h * ( ell )**( -3 ) * n
        elif order == 2:
            kernel = ( -3/2 * ( a )**( 4 ) * h * tmp1 * (ell)**(-5) * n + 4 * ( a )**( 3 ) * h * (ell)**(-3) * n )
        elif order == 3:
            kernel = ( -12 * ( a )**( 3 ) * h * tmp1 * (ell)**(-5) * n + ( 12 * ( a )**( 2 ) * h * (ell)**(-3) * n + ( a )**( 4 ) * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) )
        elif order == 4:
            kernel = ( -54 * ( a )**( 2 ) * h * tmp1 * (ell)**(-5) * n + ( 24 * a * h * (ell)**(-3) * n + ( ( a )**( 4 ) * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 12 * ( a )**( 3 ) * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) )
        elif order == 5:
            kernel = ( -144 * a * h * tmp1 * (ell)**(-5) * n + ( 24 * h * (ell)**(-3) * n + ( ( a )**( 4 ) * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + ( 16 * ( a )**( 3 ) * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 72 * ( a )**( 2 ) * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) ) )
        elif order == 6:
            kernel = ( -180 * h * tmp1 * (ell)**(-5) * n + ( ( a )**( 4 ) * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + ( 20 * ( a )**( 3 ) * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + ( 120 * ( a )**( 2 ) * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 240 * a * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) ) )
        elif order == 7:
            kernel = ( ( a )**( 4 ) * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + ( 24 * ( a )**( 3 ) * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + ( 180 * ( a )**( 2 ) * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + ( 480 * a * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 360 * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) ) )
        elif order == 8:
            kernel = ( ( a )**( 4 ) * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + ( 28 * ( a )**( 3 ) * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + ( 252 * ( a )**( 2 ) * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + ( 840 * a * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + 840 * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n ) ) ) )
        elif order == 9:
            kernel = ( ( a )**( 4 ) * h * ( 34459425/256 * ( tmp1 )**( 8 ) * (ell)**(-19) + ( -14189175/16 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( 14189175/8 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( -1091475 * ( tmp1 )**( 2 ) * (ell)**(-13) + 99225 * (ell)**(-11) ) ) ) ) * n + ( 32 * ( a )**( 3 ) * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + ( 336 * ( a )**( 2 ) * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + ( 1344 * a * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + 1680 * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n ) ) ) )
        elif order == 10:
            kernel = ( ( a )**( 4 ) * h * ( -654729075/512 * ( tmp1 )**( 9 ) * (ell)**(-21) + ( 310134825/32 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( -383107725/16 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( 42567525/2 * ( tmp1 )**( 3 ) * (ell)**(-15) + -9823275/2 * tmp1 * (ell)**(-13) ) ) ) ) * n + ( 36 * ( a )**( 3 ) * h * ( 34459425/256 * ( tmp1 )**( 8 ) * (ell)**(-19) + ( -14189175/16 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( 14189175/8 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( -1091475 * ( tmp1 )**( 2 ) * (ell)**(-13) + 99225 * (ell)**(-11) ) ) ) ) * n + ( 432 * ( a )**( 2 ) * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + ( 2016 * a * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + 3024 * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n ) ) ) )
        else:
            a, b, c, d, e, f = sy.symbols('a b c d e f')
            kernel = a**3 * sy.cos(c) \
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                kernel = h * n * ( -1 * a + ( 1/2 * ( 6 * a + -5 * b ) * ( ( a + -1 * b ) )**( \
                    -2 ) * ( b )**( 2 ) + -3 * b * np.log( ( -1 * a + b ) ) ) )
            elif np.abs(m + 1) < 1e-15:
                kernel = h * n * ( a + ( -1/2 * ( b )**( 2 ) * ( ( a + b ) )**( -2 ) * ( 6 * \
                    a + 5 * b ) + -3 * b * np.log( ( a + b ) ) ) )
            else:
                kernel = h * n * ( ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) \
                    )**( -1/2 ) * ( ( -1 + ( m )**( 2 ) ) )**( -1 ) * ( a * b * m * ( 5 + \
                    -6 * ( m )**( 2 ) ) + ( ( a )**( 2 ) * ( -1 + ( m )**( 2 ) ) + ( b \
                    )**( 2 ) * ( -2 + 3 * ( m )**( 2 ) ) ) ) + -3 * b * m * np.log( ( \
                    -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m \
            ...
            kernel = ( a )**( 3 ) * h * ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m \
                ) ) )**( -3/2 ) * n
        elif order == 2:
            kernel = ( -3/2 * ( a )**( 3 ) * h * tmp1 * (ell)**(-5) * n + 3 * ( a )**( 2 ) * h * (ell)**(-3) * n )
        elif order == 3:
            kernel = ( -9 * ( a )**( 2 ) * h * tmp1 * (ell)**(-5) * n + ( 6 * a * h * (ell)**(-3) * n + ( a )**( 3 ) * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) )
        elif order == 4:
            kernel = ( -27 * a * h * tmp1 * (ell)**(-5) * n + ( 6 * h * (ell)**(-3) * n + ( ( a )**( 3 ) * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 9 * ( a )**( 2 ) * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) )
        elif order == 5:
            kernel = ( -36 * h * tmp1 * (ell)**(-5) * n + ( ( a )**( 3 ) * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + ( 12 * ( a )**( 2 ) * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 36 * a * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) )
        elif order == 6:
            kernel = ( ( a )**( 3 ) * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + ( 15 * ( a )**( 2 ) * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + ( 60 * a * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n + 60 * h * ( 15/4 * ( tmp1 )**( 2 ) * (ell)**(-7) + -3 * (ell)**(-5) ) * n ) ) )
        elif order == 7:
            kernel = ( ( a )**( 3 ) * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + ( 18 * ( a )**( 2 ) * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + ( 90 * a * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n + 120 * h * ( -105/8 * ( tmp1 )**( 3 ) * (ell)**(-9) + 45/2 * tmp1 * (ell)**(-7) ) * n ) ) )
        elif order == 8:
            kernel = ( ( a )**( 3 ) * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + ( 21 * ( a )**( 2 ) * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + ( 126 * a * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n + 210 * h * ( 945/16 * ( tmp1 )**( 4 ) * (ell)**(-11) + ( -315/2 * ( tmp1 )**( 2 ) * (ell)**(-9) + 45 * (ell)**(-7) ) ) * n ) ) )
        elif order == 9:
            kernel = ( ( a )**( 3 ) * h * ( 34459425/256 * ( tmp1 )**( 8 ) * (ell)**(-19) + ( -14189175/16 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( 14189175/8 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( -1091475 * ( tmp1 )**( 2 ) * (ell)**(-13) + 99225 * (ell)**(-11) ) ) ) ) * n + ( 24 * ( a )**( 2 ) * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + ( 168 * a * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n + 336 * h * ( -10395/32 * ( tmp1 )**( 5 ) * (ell)**(-13) + ( 4725/4 * ( tmp1 )**( 3 ) * (ell)**(-11) + -1575/2 * tmp1 * (ell)**(-9) ) ) * n ) ) )
        elif order == 10:
            kernel = ( ( a )**( 3 ) * h * ( -654729075/512 * ( tmp1 )**( 9 ) * (ell)**(-21) + ( 310134825/32 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( -383107725/16 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( 42567525/2 * ( tmp1 )**( 3 ) * (ell)**(-15) + -9823275/2 * tmp1 * (ell)**(-13) ) ) ) ) * n + ( 27 * ( a )**( 2 ) * h * ( 34459425/256 * ( tmp1 )**( 8 ) * (ell)**(-19) + ( -14189175/16 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( 14189175/8 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( -1091475 * ( tmp1 )**( 2 ) * (ell)**(-13) + 99225 * (ell)**(-11) ) ) ) ) * n + ( 216 * a * h * ( -2027025/128 * ( tmp1 )**( 7 ) * (ell)**(-17) + ( 2837835/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( -1091475/8 * ( tmp1 )**( 3 ) * (ell)**(-13) + 99225/2 * tmp1 * (ell)**(-11) ) ) ) * n + 504 * h * ( 135135/64 * ( tmp1 )**( 6 ) * (ell)**(-15) + ( -155925/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( 42525/4 * ( tmp1 )**( 2 ) * (ell)**(-11) + -1575 * (ell)**(-9) ) ) ) * n ) ) )
        else:
            a, b, c, d, e, f = sy.symbols('a b c d e f')
            kernel = a**2 * sy.cos(c) \
                * (a*sy.cos(c)*sy.sin(e-f)) \
...
def cal_Vxx_kernel(r_cal, phi_cal, lambda_cal, \
    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                kernel = n * ( -2 * ( b )**( 3 ) * ( ( -1 * a + b ) )**( -1/2 ) + ( -6 * ( b \
                    )**( 2 ) * ( ( -1 * a + b ) )**( 1/2 ) + ( 2 * b * ( ( -1 * a + b ) \
                    )**( 3/2 ) + ( -2/5 * ( ( -1 * a + b ) )**( 5/2 ) + ( 30 * ( ( a + -1 \
                    * b ) )**( -1 ) * ( b )**( 2 ) * ( g )**( 2 ) + ( 15 * ( ( a + -1 * b \
                    ) )**( -2 ) * ( b )**( 3 ) * ( g )**( 2 ) + ( 5 * ( ( a + -1 * b ) \
                    )**( -3 ) * ( b )**( 4 ) * ( g )**( 2 ) + ( 3/4 * ( ( a + -1 * b ) \
                    )**( -4 ) * ( b )**( 5 ) * ( g )**( 2 ) + ( 3 * ( -1 * a + b ) * ( g \
                    )**( 2 ) + -15 * b * ( g )**( 2 ) * np.log( ( -1 * a + b ) ) ) ) ) \
                    ) ) ) ) ) )
            elif np.abs(m + 1) < 1e-15:
                kernel = n * ( -2 * ( b )**( 3 ) * ( ( a + b ) )**( -1/2 ) + ( -6 * ( b )**( 2 \
                    ) * ( ( a + b ) )**( 1/2 ) + ( 2 * b * ( ( a + b ) )**( 3/2 ) + ( \
                    -2/5 * ( ( a + b ) )**( 5/2 ) + ( 3/4 * ( b )**( 5 ) * ( ( a + b ) \
                    )**( -4 ) * ( g )**( 2 ) + ( -5 * ( b )**( 4 ) * ( ( a + b ) )**( -3 \
                    ) * ( g )**( 2 ) + ( 15 * ( b )**( 3 ) * ( ( a + b ) )**( -2 ) * ( g \
                    )**( 2 ) + ( -30 * ( b )**( 2 ) * ( ( a + b ) )**( -1 ) * ( g )**( 2 \
                    ) + ( 3 * ( a + b ) * ( g )**( 2 ) + -15 * b * ( g )**( 2 ) * \
                ...
                kernel = n * ( (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( ( a )**( 4 ) * ( -1 + 3 * ( g )**( 2 ) ) * ( ( -1 + ( m )**( 2 ) ) )**( 2 ) + ( ( a )**( 3 ) * b * m * ( 7 + ( -15 * ( m )**( 2 ) + ( 8 * ( m )**( 4 ) + ( g )**( 2 ) * ( -32 + ( 74 * ( m )**( 2 ) + -40 * ( m )**( 4 ) ) ) ) ) ) + ( ( b )**( 4 ) * ( -2 + ( 5 * ( m )**( 2 ) + ( -3 * ( m )**( 4 ) + ( g )**( 2 ) * ( 8 + ( -25 * ( m )**( 2 ) + 15 * ( m )**( 4 ) ) ) ) ) ) + ( -3 * a * ( b )**( 3 ) * m * ( -3 + ( 7 * ( m )**( 2 ) + ( -4 * ( m )**( 4 ) + ( g )**( 2 ) * ( 13 + ( -35 * ( m )**( 2 ) + 20 * ( m )**( 4 ) ) ) ) ) ) + 3 * ( a )**( 2 ) * ( b )**( 2 ) * ( -1 + ( -1 * ( m )**( 2 ) + ( 6 * ( m )**( 4 ) + ( -4 * ( m )**( 6 ) + ( g )**( 2 ) * ( 4 + ( 4 * ( m )**( 2 ) + ( -30 * ( m )**( 4 ) + 20 * ( m )**( 6 ) ) ) ) ) ) ) ) ) ) ) ) + -3 * b * ( -1 + 5 * ( g )**( 2 ) ) * m * np.log( ( -1 * a + ( b * m + ell ) ) ) )
        elif order == 1:
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                kernel = n * ( -2 * ( b )**( 2 ) * ( ( -1 * a + b ) )**( -1/2 ) + ( -4 * b * ( \
                    ( -1 * a + b ) )**( 1/2 ) + ( 2/3 * ( ( -1 * a + b ) )**( 3/2 ) + ( \
                    12 * ( ( a + -1 * b ) )**( -1 ) * b * ( g )**( 2 ) + ( 9 * ( ( a + -1 \
                    * b ) )**( -2 ) * ( b )**( 2 ) * ( g )**( 2 ) + ( 4 * ( ( a + -1 * b \
                    ) )**( -3 ) * ( b )**( 3 ) * ( g )**( 2 ) + ( 3/4 * ( ( a + -1 * b ) \
                    )**( -4 ) * ( b )**( 4 ) * ( g )**( 2 ) + -3 * ( g )**( 2 ) * \
                    np.log( ( -1 * a + b ) ) ) ) ) ) ) ) )
            elif np.abs(m + 1) < 1e-15:
                kernel = n * ( 1/12 * ( ( a + b ) )**( -4 ) * ( 24 * ( b )**( 2 ) * ( ( a + b \
                    ) )**( 7/2 ) + ( -8 * a * ( ( a + b ) )**( 9/2 ) + ( 40 * b * ( ( a + \
                    b ) )**( 9/2 ) + ( 144 * ( a )**( 3 ) * b * ( g )**( 2 ) + ( 324 * ( \
                    a )**( 2 ) * ( b )**( 2 ) * ( g )**( 2 ) + ( 264 * a * ( b )**( 3 ) * \
                    ( g )**( 2 ) + 75 * ( b )**( 4 ) * ( g )**( 2 ) ) ) ) ) ) ) + 3 * ( g \
                    )**( 2 ) * np.log( ( a + b ) ) )
            else:
                kernel = n * ( (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( ( a )**( 2 ) * b * m * ( -1 + ( ( 5 + -18 * ( g )**( 2 ) ) * ( m )**( 2 ) + 4 * ( -1 + 3 * ( g )**( 2 ) ) * ( m )**( 4 ) ) ) + ( ( b )**( 3 ) * m * ( 1 + ( -1 * ( m )**( 2 ) + ( g )**( 2 ) * ( -5 + 3 * ( m )**( 2 ) ) ) ) + ( a * ( b )**( 2 ) * ( 1 + ( -5 * ( m )**( 2 ) + ( 4 * ( m )**( 4 ) + -3 * ( g )**( 2 ) * ( 1 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) ) ) ) + ( a )**( 3 ) * ( 1 + ( -3 * ( m )**( 2 ) + ( 2 * ( m )**( 4 ) + -2 * ( g )**( 2 ) * ( 2 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) ) ) ) ) ) ) + ( 1 + -3 * ( g )**( 2 ) ) * np.log( ( -1 * a + ( b * m + ell ) ) ) )
        elif order == 1:
            ...
            kernel =  ( 6 * ( -15/2 * ( a )**( 2 ) * ( g )**( 2 ) * ( 2 * a + -2 * b * m ) * (ell)**(-7) + ( 6 * a * ( g )**( 2 ) * (ell)**(-5) + 3/2 * ( 2 * a + -2 * b * m ) * (ell)**(-5) ) ) + ( ( a )**( 2 ) * ( 105/8 * ( ( 2 * a + -2 * b * m ) )**( 3 ) * (ell)**(-9) + ( -45/2 * ( 2 * a + -2 * b * m ) * (ell)**(-7) + ( -45 * ( g )**( 2 ) * ( 2 * a + -2 * b * m ) * (ell)**(-7) + ( 3 * ( a )**( 2 ) * ( g )**( 2 ) * ( -315/8 * ( ( 2 * a + -2 * b * m ) )**( 3 ) * (ell)**(-11) + 105/2 * ( 2 * a + -2 * b * m ) * (ell)**(-9) ) + 18 * a * ( g )**( 2 ) * ( 35/4 * ( ( 2 * a + -2 * b * m ) )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) + 6 * a * ( -30 * a * ( g )**( 2 ) * ( 2 * a + -2 * b * m ) * (ell)**(-7) + ( -15/4 * ( ( 2 * a + -2 * b * m ) )**( 2 ) * (ell)**(-7) + ( 3 * (ell)**(-5) + ( 6 * ( g )**( 2 ) * (ell)**(-5) + 3 * ( a )**( 2 ) * ( g )**( 2 ) * ( 35/4 * ( ( 2 * a + -2 * b * m ) )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) ) ) * n
        elif order == 5:
    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = 3 * n * p * ( 1/3 * (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( 3 * ( a )**( 4 ) * ( ( -1 + ( m )**( 2 ) ) )**( 2 ) + ( ( b )**( 4 ) * ( 8 + ( -25 * ( m )**( 2 ) + 15 * ( m )**( 4 ) ) ) + ( -2 * ( a )**( 3 ) * b * m * ( 16 + ( -37 * ( m )**( 2 ) + 20 * ( m )**( 4 ) ) ) + ( -3 * a * ( b )**( 3 ) * m * ( 13 + ( -35 * ( m )**( 2 ) + 20 * ( m )**( 4 ) ) ) + 6 * ( a )**( 2 ) * ( b )**( 2 ) * ( 2 + ( 2 * ( m )**( 2 ) + ( -15 * ( m )**( 4 ) + 10 * ( m )**( 6 ) ) ) ) ) ) ) ) + -5 * b * m * np.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
            kernel = 3 * ( a )**( 5 ) * (ell)**(-5) * n * p
        elif order == 2:
            kernel = ( -15/2 * ( a )**( 5 ) * tmp1 * (ell)**(-7) * n * p + 15 * ( a )**( 4 ) * (ell)**(-5) * n * p )
        elif order == 3:
            kernel = ( -75 * ( a )**( 4 ) * tmp1 * (ell)**(-7) + ( 60 * ( a )**( 3 ) * (ell)**(-5) + 3 * ( a )**( 5 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) * n * p
        elif order == 4:
            kernel = ( -450 * ( a )**( 3 ) * tmp1 * (ell)**(-7) + ( 180 * ( a )**( 2 ) * (ell)**(-5) + ( 3 * ( a )**( 5 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 45 * ( a )**( 4 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) * n * p
        elif order == 5:
            kernel = ( -1800 * ( a )**( 2 ) * tmp1 * (ell)**(-7) + ( 360 * a * (ell)**(-5) + ( 3 * ( a )**( 5 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 60 * ( a )**( 4 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 360 * ( a )**( 3 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) * n * p
        elif order == 6:
            kernel = ( -4500 * a * tmp1 * (ell)**(-7) + ( 360 * (ell)**(-5) + ( 3 * ( a )**( 5 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 75 * ( a )**( 4 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 600 * ( a )**( 3 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 1800 * ( a )**( 2 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) ) * n * p
        elif order == 7:
            kernel = ( -5400 * tmp1 * (ell)**(-7) + ( 3 * ( a )**( 5 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 90 * ( a )**( 4 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 900 * ( a )**( 3 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 3600 * ( a )**( 2 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 5400 * a * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) ) * n * p
        elif order == 8:
            kernel = ( 3 * ( a )**( 5 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 105 * ( a )**( 4 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 1260 * ( a )**( 3 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 6300 * ( a )**( 2 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 12600 * a * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 7560 * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) ) * n * p
        elif order == 9:
            kernel = ( 3 * ( a )**( 5 ) * ( 218243025/256 * ( tmp1 )**( 8 ) * (ell)**(-21) + ( -80405325/16 * ( tmp1 )**( 6 ) * (ell)**(-19) + ( 70945875/8 * ( tmp1 )**( 4 ) * (ell)**(-17) + ( -4729725 * ( tmp1 )**( 2 ) * (ell)**(-15) + 363825 * (ell)**(-13) ) ) ) ) + ( 120 * ( a )**( 4 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 1680 * ( a )**( 3 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 10080 * ( a )**( 2 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 25200 * a * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + 20160 * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) ) ) ) ) ) * n * p
        elif order == 10:
            kernel = ( 3 * ( a )**( 5 ) * ( -4583103525/512 * ( tmp1 )**( 9 ) * (ell)**(-23) + ( 1964187225/32 * ( tmp1 )**( 7 ) * (ell)**(-21) + ( -2170943775/16 * ( tmp1 )**( 5 ) * (ell)**(-19) + ( 212837625/2 * ( tmp1 )**( 3 ) * (ell)**(-17) + -42567525/2 * tmp1 * (ell)**(-15) ) ) ) ) + ( 135 * ( a )**( 4 ) * ( 218243025/256 * ( tmp1 )**( 8 ) * (ell)**(-21) + ( -80405325/16 * ( tmp1 )**( 6 ) * (ell)**(-19) + ( 70945875/8 * ( tmp1 )**( 4 ) * (ell)**(-17) + ( -4729725 * ( tmp1 )**( 2 ) * (ell)**(-15) + 363825 * (ell)**(-13) ) ) ) ) + ( 2160 * ( a )**( 3 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 15120 * ( a )**( 2 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 45360 * a * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + 45360 * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) ) ) ) ) ) * n * p
        else:
                a, b, c, d, e, f = sy.symbols('a b c d e f')
                kernel = a**3 * sy.cos(c) \
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = 3 * n * p * ( 1/3 * (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( 6 * ( a )**( 2 ) * b * ( m )**( 3 ) * ( -3 + 2 * ( m )**( 2 ) ) + ( ( b )**( 3 ) * m * ( -5 + 3 * ( m )**( 2 ) ) + ( -3 * a * ( b )**( 2 ) * ( 1 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) + -2 * ( a )**( 3 ) * ( 2 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) ) ) ) + -1 * np.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
            kernel = 3 * ( a )**( 4 ) * (ell)**(-5) * n * p
        elif order == 2:
            kernel = ( -15/2 * ( a )**( 4 ) * tmp1 * (ell)**(-7) * n * p + 12 * ( a )**( 3 ) * (ell)**(-5) * n * p )
        elif order == 3:
            kernel = ( -60 * ( a )**( 3 ) * tmp1 * (ell)**(-7) + ( 36 * ( a )**( 2 ) * (ell)**(-5) + 3 * ( a )**( 4 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) * n * p
        elif order == 4:
            kernel = ( -270 * ( a )**( 2 ) * tmp1 * (ell)**(-7) + ( 72 * a * (ell)**(-5) + ( 3 * ( a )**( 4 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 36 * ( a )**( 3 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) * n * p
        elif order == 5:
            kernel = ( -720 * a * tmp1 * (ell)**(-7) + ( 72 * (ell)**(-5) + ( 3 * ( a )**( 4 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 48 * ( a )**( 3 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 216 * ( a )**( 2 ) * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) * n * p
        elif order == 6:
            kernel = ( -900 * tmp1 * (ell)**(-7) + ( 3 * ( a )**( 4 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 60 * ( a )**( 3 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 360 * ( a )**( 2 ) * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 720 * a * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) * n * p
        elif order == 7:
            kernel = ( 3 * ( a )**( 4 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 72 * ( a )**( 3 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 540 * ( a )**( 2 ) * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + ( 1440 * a * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) + 1080 * ( 35/4 * ( tmp1 )**( 2 ) * (ell)**(-9) + -5 * (ell)**(-7) ) ) ) ) ) * n * p
        elif order == 8:
            kernel = ( 3 * ( a )**( 4 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 84 * ( a )**( 3 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 756 * ( a )**( 2 ) * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + ( 2520 * a * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) + 2520 * ( -315/8 * ( tmp1 )**( 3 ) * (ell)**(-11) + 105/2 * tmp1 * (ell)**(-9) ) ) ) ) ) * n * p
        elif order == 9:
            kernel = ( 3 * ( a )**( 4 ) * ( 218243025/256 * ( tmp1 )**( 8 ) * (ell)**(-21) + ( -80405325/16 * ( tmp1 )**( 6 ) * (ell)**(-19) + ( 70945875/8 * ( tmp1 )**( 4 ) * (ell)**(-17) + ( -4729725 * ( tmp1 )**( 2 ) * (ell)**(-15) + 363825 * (ell)**(-13) ) ) ) ) + ( 96 * ( a )**( 3 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 1008 * ( a )**( 2 ) * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + ( 4032 * a * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) + 5040 * ( 3465/16 * ( tmp1 )**( 4 ) * (ell)**(-13) + ( -945/2 * ( tmp1 )**( 2 ) * (ell)**(-11) + 105 * (ell)**(-9) ) ) ) ) ) ) * n * p
        elif order == 10:
            kernel = ( 3 * ( a )**( 4 ) * ( -4583103525/512 * ( tmp1 )**( 9 ) * (ell)**(-23) + ( 1964187225/32 * ( tmp1 )**( 7 ) * (ell)**(-21) + ( -2170943775/16 * ( tmp1 )**( 5 ) * (ell)**(-19) + ( 212837625/2 * ( tmp1 )**( 3 ) * (ell)**(-17) + -42567525/2 * tmp1 * (ell)**(-15) ) ) ) ) + ( 108 * ( a )**( 3 ) * ( 218243025/256 * ( tmp1 )**( 8 ) * (ell)**(-21) + ( -80405325/16 * ( tmp1 )**( 6 ) * (ell)**(-19) + ( 70945875/8 * ( tmp1 )**( 4 ) * (ell)**(-17) + ( -4729725 * ( tmp1 )**( 2 ) * (ell)**(-15) + 363825 * (ell)**(-13) ) ) ) ) + ( 1296 * ( a )**( 2 ) * ( -11486475/128 * ( tmp1 )**( 7 ) * (ell)**(-19) + ( 14189175/32 * ( tmp1 )**( 5 ) * (ell)**(-17) + ( -4729725/8 * ( tmp1 )**( 3 ) * (ell)**(-15) + 363825/2 * tmp1 * (ell)**(-13) ) ) ) + ( 6048 * a * ( 675675/64 * ( tmp1 )**( 6 ) * (ell)**(-17) + ( -675675/16 * ( tmp1 )**( 4 ) * (ell)**(-15) + ( 155925/4 * ( tmp1 )**( 2 ) * (ell)**(-13) + -4725 * (ell)**(-11) ) ) ) + 9072 * ( -45045/32 * ( tmp1 )**( 5 ) * (ell)**(-15) + ( 17325/4 * ( tmp1 )**( 3 ) * (ell)**(-13) + -4725/2 * tmp1 * (ell)**(-11) ) ) ) ) ) ) * n * p
        else:
            a, b, c, d, e, f = sy.symbols('a b c d e f')
            kernel = a**2 * sy.cos(c) \
                * (3*(a*(sy.cos(d)*sy.sin(c)-sy.sin(d)*sy.cos(c)*sy.cos(e-f))) \
