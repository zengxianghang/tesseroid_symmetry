    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = 3 * g * h * n * ( 1/3 * (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( 3 * ( a )**( 4 ) * ( ( -1 + ( m )**( 2 ) ) )**( 2 ) + ( ( b )**( 4 ) * ( 8 + ( -25 * ( m )**( 2 ) + 15 * ( m )**( 4 ) ) ) + ( -2 * ( a )**( 3 ) * b * m * ( 16 + ( -37 * ( m )**( 2 ) + 20 * ( m )**( 4 ) ) ) + ( -3 * a * ( b )**( 3 ) * m * ( 13 + ( -35 * ( m )**( 2 ) + 20 * ( m )**( 4 ) ) ) + 6 * ( a )**( 2 ) * ( b )**( 2 ) * ( 2 + ( 2 * ( m )**( 2 ) + ( -15 * ( m )**( 4 ) + 10 * ( m )**( 6 ) ) ) ) ) ) ) ) + -5 * b * m * numpy.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = 3 * g * h * n * ( 1/3 * (ell)**(-3) * ( ( -1 + ( m )**( 2 ) ) )**( -2 ) * ( 6 * ( a )**( 2 ) * b * ( m )**( 3 ) * ( -3 + 2 * ( m )**( 2 ) ) + ( ( b )**( 3 ) * m * ( -5 + 3 * ( m )**( 2 ) ) + ( -3 * a * ( b )**( 2 ) * ( 1 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) + -2 * ( a )**( 3 ) * ( 2 + ( -7 * ( m )**( 2 ) + 4 * ( m )**( 4 ) ) ) ) ) ) + -1 * numpy.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
