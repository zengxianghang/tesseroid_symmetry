    ...
    if is_linear_density:
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = kernel = 1/2 * g * n * ( (ell)**(-1) * ( ( -1 + ( m )**( 2 ) ) )**( -1 ) * ( ( a )**( 3 ) * ( -1 + ( m )**( 2 ) ) + ( 5 * ( a )**( 2 ) * b * m * ( -1 + ( m )**( 2 ) ) + ( ( b )**( 3 ) * m * ( -13 + 15 * ( m )**( 2 ) ) + a * ( b )**( 2 ) * ( -3 + ( 31 * ( m )**( 2 ) + -30 * ( m )**( 4 ) ) ) ) ) ) + -3 * ( b )**( 2 ) * ( -1 + 5 * ( m )**( 2 ) ) * np.log( ( -1 * a + ( b * m + ( ( ( a )**( 2 ) + ( ( b )**( 2 ) + -2 * a * b * m ) ) )**( 1/2 ) ) ) ) )
        elif order == 1:
        ...
        if order == 0:
            if np.abs(m - 1) < 1e-15:
                ...
                kernel = g * n * ( a + ( -1/2 * ( b )**( 2 ) * ( ( a + b ) )**( -2 ) * ( 6 * a \
                    + 5 * b ) + -3 * b * np.log( ( a + b ) ) ) )
            else:
